...
@section('auth-content')
    ...
    <div class="mb-8 relative">
        ...
        <div class="flex justify-between w-full max-w-xs mx-auto">
            <div class="step-indicator group" data-step="1">
                <div id="ind-1"
                    class="w-10 h-10 rounded-full flex items-center justify-center bg-blue-600 text-white font-bold ring-4 ring-white transition-all duration-300 shadow-md">
                    1</div>
            </div>
            <div class="step-indicator group relative" data-step="2">
                <div id="ind-2"
                    class="w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 text-gray-400 font-bold ring-4 ring-white transition-all duration-300 border-2 border-transparent">
                    2</div>
                <div class="absolute -bottom-6 left-1/2 -translate-x-1/2 w-max"><span id="text-2"
                        class="text-xs font-semibold text-gray-400">Ubicación</span></div>
            </div>
            <div class="step-indicator group relative" data-step="3">
                <div id="ind-3"
                    class="w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 text-gray-400 font-bold ring-4 ring-white transition-all duration-300 border-2 border-transparent">
                    3</div>
                <div class="absolute -bottom-6 left-1/2 -translate-x-1/2 w-max"><span id="text-3"
                        class="text-xs font-semibold text-gray-400">Cuenta</span></div>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" id="registerForm" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="primer_nombre" id="primer_nombre"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('primer_nombre') border-red-500 @enderror"
                        required maxlength="20" value="{{ old('primer_nombre') }}">
                ...
                <div>
                    ...
                    <input type="text" name="segundo_nombre" id="segundo_nombre"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('segundo_nombre') border-red-500 @enderror"
                        required maxlength="20" value="{{ old('segundo_nombre') }}">
                ...
                <div>
                    ...
                    <input type="text" name="primer_apellido" id="primer_apellido"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('primer_apellido') border-red-500 @enderror"
                        required maxlength="20" value="{{ old('primer_apellido') }}">
                ...
                <!-- Segundo Apellido -->
                <div>
                    <label for="segundo_apellido" class="block text-sm font-medium text-slate-700">Segundo Apellido
                        *</label>
                    <input type="text" name="segundo_apellido" id="segundo_apellido"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('segundo_apellido') border-red-500 @enderror"
                        required maxlength="20" value="{{ old('segundo_apellido') }}">
                ...
                <div>
                    ...
                    <div class="flex gap-2 mt-1">
                        ...
                        <input type="text" name="numero_documento" id="numero_documento" placeholder="123456789"
                            class="block flex-1 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('numero_documento') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input type="date" name="fecha_nac" id="fecha_nac"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('fecha_nac') border-red-500 @enderror"
                        required value="{{ old('fecha_nac') }}">
                    <span id="label-edad" class="text-xs font-medium mt-1 hidden"></span>
                ...
                <div>
                    ...
                    <select name="genero" id="genero"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('genero') border-red-500 @enderror"
                        required>
                ...
                <div>
                    ...
                    <div class="flex gap-2 mt-1">
                        ...
                        <input type="tel" name="numero_tlf" id="numero_tlf" placeholder="4121234567"
                            class="block flex-1 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('numero_tlf') border-red-500 @enderror"
                            required maxlength="15" value="{{ old('numero_tlf') }}">
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="direccion" id="direccion"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                            placeholder="Av. Ppal, Edif. A, Apto 1" value="{{ old('direccion') }}">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="email" name="correo" id="correo"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('correo') border-red-500 @enderror"
                        required placeholder="ejemplo@email.com" value="{{ old('correo') }}">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                    <div>
                        ...
                        <div class="relative mt-1">
                            <input type="password" name="password" id="password"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm pr-10 @error('password') border-red-500 @enderror"
                                required placeholder="Tu contraseña segura">
                        ...
                        <div class="mt-2">
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-1.5">
                                <div id="strength-bar" class="bg-red-500 h-1.5 rounded-full transition-all duration-300"
                                    style="width: 0%"></div>
                            </div>
                        </div>
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-sm font-medium text-slate-700">Repetir
                            Contraseña *</label>
                        <div class="relative mt-1">
                    ...
                    <div class="space-y-3">
                        @for($i = 1; $i <= 3; $i++)
                            <div>
                                ...
                                <input type="text" name="respuesta_seguridad_{{ $i }}" id="respuesta_seguridad_{{ $i }}"
                                    class="mt-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm py-2"
                                    placeholder="Respuesta" required value="{{ old("respuesta_seguridad_$i") }}">
        ...
        <div class="flex justify-between pt-6 border-t border-gray-100 items-center">
            <a href="{{ route('login') }}"
                class="text-sm text-slate-500 hover:text-medical-600 font-medium transition-colors">
            ...
            <div class="flex gap-3">
                ...
                <button type="submit" id="submitBtn"
                    class="hidden px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
    ...
    @push('scripts')
        <script>
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (fechaNacInput && labelEdad) {
                    fechaNacInput.addEventListener('change', () => {
                        ...
                        if (isNaN(edad)) {
                            labelEdad.classList.add('hidden');
                            return;
                        }
                        ...
                        if (edad >= 18 && edad <= 100) {
                            ...
                            labelEdad.classList.remove('hidden');
                            labelEdad.className = "text-xs text-red-600 font-medium mt-1 block";
                            labelEdad.textContent = "La edad no puede ser mayor a 100 años";
                        } else {
                            labelEdad.classList.remove('hidden');
                            labelEdad.className = "text-xs text-red-600 font-medium mt-1 block";
                            labelEdad.textContent = "Debe ser mayor de 18 años";
                        }
                    });
                }
                ...
                nameFields.forEach(id => {
                    ...
                    if (el) {
                        el.addEventListener('input', function () {
                            // Limpiar no-letras y truncar a 20
                            this.value = this.value.replace(/[^a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s]/g, '').substring(0, 20);
                            // Forzar validación de formato básico para quitar error si ya es válido
                            validateField(id, this.value, 'input');
                        });
                    }
                });
                ...
                async function validarDocumento() {
                    ...
                    let numero = numDocInput.value;

                    // Bloqueo físico según tipo
                    if (['V', 'E', 'J'].includes(tipo)) {
                        numero = numero.replace(/\D/g, '');
                    } else if (tipo === 'P') {
                        numero = numero.replace(/[^a-zA-Z0-9]/g, '');
                    }

                    // Límite físico: V/E (10 chars max para seguridad), P/J (9 chars)
                    const maxLen = (tipo === 'P' || tipo === 'J') ? 9 : 10;
                    if (numero.length > maxLen) {
                        numero = numero.substring(0, maxLen);
                    }
                    numDocInput.value = numero;
                    ...
                    // --- VALIDACIÓN LOCAL SEGÚN TIPO ---
                    let errorLocal = null;
                    const numInt = parseInt(numero);

                    if (tipo === 'V') {
                        if (numInt <= 100000 || numInt > 50000000) errorLocal = "Cédula V debe estar entre 100,000 y 50,000,000";
                    } else if (tipo === 'E') {
                        if (numInt <= 50000000 || numInt > 100000000) errorLocal = "Cédula E debe estar entre 50,000,001 y 100,000,000";
                    } else if (tipo === 'P') {
                        if (numero.length < 8) errorLocal = "Pasaporte debe tener al menos 8 caracteres";
                    } else if (tipo === 'J') {
                        if (numero.length < 8) errorLocal = "RIF Jurídico debe tener al menos 8 caracteres";
                    }

                    if (errorLocal) {
                        showError('numero_documento', errorLocal);
                        window.asyncValidations.documento = false;
                        return;
                    }
                ...
                if (tipoDocInput && numDocInput) {
                    ...
                    numDocInput.addEventListener('input', validarDocumento);
                }
            ...
            const validationRules = {
                'primer_nombre': { required: true, regex: /^[a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s]+$/, maxLen: 20, msg: 'Máximo 20 letras' },
                'segundo_nombre': { required: true, regex: /^[a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s]+$/, maxLen: 20, msg: 'Máximo 20 letras' },
                'primer_apellido': { required: true, regex: /^[a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s]+$/, maxLen: 20, msg: 'Máximo 20 letras' },
                'segundo_apellido': { required: true, regex: /^[a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s]+$/, maxLen: 20, msg: 'Máximo 20 letras' },
                // numero_documento se maneja exclusivamente por validarDocumento()
            ...
            function validateField(id, value, eventType = 'blur') {
                ...
                if (eventType === 'blur' || eventType === 'submit') {
                    if (rule.required && !value.trim()) {
                        ...
                        valid = false;
                        errorMsg = `Máximo ${rule.maxLen} caracteres`;
            ...
            window.validateStep = async function (step) {
                ...
                // Specific Step 1 Checks (Age & Document)
                if (step === 1) {
                    // Re-validar documento localmente por si acaso
                    const tipo = document.getElementById('tipo_documento').value;
                    const numero = document.getElementById('numero_documento').value;
                    const numInt = parseInt(numero);

                    if (!numero) {
                        showError('numero_documento', 'Campo requerido');
                        isValid = false;
                    } else {
                        if (tipo === 'V' && (numInt <= 100000 || numInt > 50000000)) {
                            showError('numero_documento', "Cédula V debe estar entre 100,000 y 50,000,000");
                            isValid = false;
                        } else if (tipo === 'E' && (numInt <= 50000000 || numInt > 100000000)) {
                            showError('numero_documento', "Cédula E debe estar entre 50,000,001 y 100,000,000");
                            isValid = false;
                        } else if (tipo === 'P' && numero.length < 8) {
                            showError('numero_documento', "Pasaporte debe tener al menos 8 caracteres");
                            isValid = false;
                        } else if (tipo === 'J' && numero.length < 8) {
                            showError('numero_documento', "RIF Jurídico debe tener al menos 8 caracteres");
                            isValid = false;
                        }
                    }
                    ...
                    if (fechaNac) {
                        ...
                        if (edad < 18 || edad > 100) {
                            ...
                            if (label) {
                                label.className = "text-xs text-red-600 font-medium mt-1 block";
                                label.textContent = edad > 100 ? "La edad no puede ser mayor a 100 años" : "Debe ser mayor de 18 años";
                            }
                        }
                    }

                    // AJAX Check for Document (Solo si pasó validación local)
                    if (isValid) {
                        try {
                            const response = await fetch('{{ route("validate.document") }}', {
                                method: 'POST',
                            ...
                            console.error(e);
                            // En caso de error de red, permitimos seguir si no es crítico? 
                            // Mejor dejarlo pasar si no podemos verificar.
                        }
                    }
                }
