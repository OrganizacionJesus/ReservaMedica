    ...
    <form action="{{ route('admin.perfil.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="primer_nombre" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all" 
                        ...
                        <div>
                            ...
                            <input type="text" name="segundo_nombre" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all" 
                        ...
                        <div>
                            ...
                            <input type="text" name="primer_apellido" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all" 
                        ...
                        <div>
                            ...
                            <input type="text" name="segundo_apellido" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all" 
                        ...
                        <div>
                            ...
                            <input type="date" name="fecha_nac" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all" 
                        ...
                        <div>
                            ...
                            <select name="genero" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all">
                ...
                <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="prefijo_tlf" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all">
                                <option value="">Seleccione...</option>
                        ...
                        <div>
                            ...
                            <input type="text" name="numero_tlf" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all" 
                ...
                <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="estado_id" id="estado_id" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all">
                                <option value="">Seleccione...</option>
                        ...
                        <div>
                            ...
                            <select name="ciudad_id" id="ciudad_id" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all">
                                <option value="">Seleccione...</option>
                        ...
                        <div>
                            ...
                            <select name="municipio_id" id="municipio_id" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all">
                                <option value="">Seleccione...</option>
                        ...
                        <div>
                            ...
                            <select name="parroquia_id" id="parroquia_id" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all">
                                <option value="">Seleccione...</option>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="direccion_detallada" rows="3" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all" 
                ...
                <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="password" name="password" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all" 
                        ...
                        <div>
                            ...
                            <input type="password" name="password_confirmation" class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all" 
            ...
            <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-center">
                            <div class="relative group">
                                ...
                                @else
                                    <div id="preview_image" class="w-32 h-32 rounded-full bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center text-5xl text-blue-700 font-bold border-4 border-white shadow-lg">
                                        {{ strtoupper(substr($administrador->primer_nombre ?? 'A', 0, 1)) }}
                                    </div>
                                @endif
                        ...
                        <!-- Upload -->
                        <div>
                            <label for="foto_perfil" class="flex items-center justify-center gap-2 px-4 py-2 rounded-xl border-2 border-dashed border-gray-200 text-gray-600 hover:border-blue-500 hover:text-blue-600 hover:bg-blue-50 cursor-pointer transition-all">
                ...
                <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
                    <h3 class="text-lg font-display font-bold text-gray-900 mb-6 flex items-center gap-2">
                        <i class="bi bi-palette text-pink-600"></i>
                        Personalización
                    </h3>
                    ...
                    <div class="space-y-6">
                        ...
                        <div id="banner_preview_container" class="relative h-28 rounded-2xl overflow-hidden border border-gray-100 shadow-inner group">
                            ...
                            @else
                                <div id="preview_banner_color" class="w-full h-full {{ $administrador->banner_color ?? 'bg-gradient-to-r from-blue-500 to-indigo-600' }}"
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                @foreach($gradients as $grad)
                                    <button type="button" onclick="setBannerColor('{{ $grad }}')" 
                                            class="w-7 h-7 rounded-lg {{ $grad }} border-2 {{ ($administrador->banner_color == $grad) ? 'border-blue-500 scale-110 shadow-lg' : 'border-white' }} transition-all">
                                    </button>
                                @endforeach
                                ...
                                <div class="relative flex items-center">
                                    ...
                                    <div class="w-7 h-7 rounded-lg bg-gray-50 border-2 border-gray-200 flex items-center justify-center text-gray-400 hover:text-blue-500 transition-colors">
                ...
                <div class="card p-5 bg-gray-50 border-none">
                    <div class="space-y-2 text-xs">
                        <div class="flex justify-between items-baseline">
                            ...
                            <span class="font-bold text-blue-600 px-2 py-0.5 bg-blue-50 rounded-lg">{{ $administrador->tipo_admin }}</span>
                        </div>
                ...
                <div class="flex flex-col gap-3">
                    <button type="submit" class="w-full py-3 bg-blue-600 text-white rounded-2xl font-bold shadow-lg shadow-blue-200 hover:bg-blue-700 hover:-translate-y-0.5 transition-all">
...
<script>
    function previewImage(event) {
        ...
        reader.onload = function(e) {
            ...
            preview.innerHTML = `<img src="${e.target.result}" alt="Preview" class="w-32 h-32 rounded-full object-cover border-4 border-blue-100 shadow-lg">`;
        }
    ...
    function setBannerColor(color) {
        ...
        document.querySelectorAll('[onclick^="setBannerColor"]').forEach(btn => {
            btn.classList.remove('border-blue-500', 'scale-110', 'shadow-lg');
        ...
        if (!color.startsWith('#')) {
            ...
            if (selectedBtn) {
                ...
                selectedBtn.classList.add('border-blue-500', 'scale-110', 'shadow-lg');
            }
        }
    ...
    function updateDynamicPreview() {
        ...
        if (isEnabled && color) {
            let baseColor = '#2563eb'; // Default blue-600
            if (color.startsWith('#')) {
                baseColor = color;
                ...
                if (match) {
                    const colors = {
                        medical: '#10b981', emerald: '#10b981', blue: '#2563eb', 
                        teal: '#14b8a6', purple: '#9333ea', rose: '#e11d48', 
                        slate: '#475569', orange: '#ea580c', indigo: '#4f46e5', cyan: '#0891b2'
                    };
            ...
            styleTag.innerHTML = `
                ...
                .bg-blue-600 { background-color: var(--medical-500) !important; }
                .text-blue-600 { color: var(--medical-500) !important; }
                .bg-blue-50 { background-color: var(--medical-50) !important; }
                .border-blue-500 { border-color: var(--medical-500) !important; }
                .shadow-blue-200 { --tw-shadow-color: var(--medical-200) !important; }
    ...
    // Initialize dynamic preview on load
    document.addEventListener('DOMContentLoaded', updateDynamicPreview);
</script>
@endpush
@endsection
