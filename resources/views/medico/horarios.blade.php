...
<script>
    ...
    window.getConsultorioData = function(id) {
        ...
        // DEPURACIÓN: Ver qué ID se está buscando y qué hay en rawHorarios
        console.log('Buscando consultorio:', id, 'Tipo:', typeof id);
        console.log('rawHorarios disponibles:', window.rawHorarios);
    ...
    // DEPURACIÓN INICIAL
    console.log('=== DIAGNÓSTICO DE HORARIOS ===');
    console.log('window.rawHorarios:', window.rawHorarios);
    console.log('Claves de rawHorarios:', Object.keys(window.rawHorarios));
